// Auto-generated index file for animal classes
// Separated by classCategory
...
export { birdsAnimals } from './birds';
export { fishesAnimals } from './fishes';
export { invertebratesAnimals } from './invertebrates';
export { mammalsAnimals } from './mammals';
export { reptilesamphibiansAnimals } from './reptiles_and_amphibians';
